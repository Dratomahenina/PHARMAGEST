...
public class MedicamentController {
    ...
    @FXML
    private TableColumn<Medicament, String> categorieMedicamentColumn;
    @FXML
    ...
    public void initialize() {
        ...
        categorieMedicamentColumn.setCellValueFactory(new PropertyValueFactory<>("categorieMedicament"));
        formeMedicamentColumn.setCellValueFactory(new PropertyValueFactory<>("formeMedicament"));
    ...
    @FXML
    private void handleIdMedicamentSort(MouseEvent event) {
    ...
    @FXML
    private void handleNomMedicamentSort(MouseEvent event) {
        medicamentList.sort((m1, m2) -> {
