...
-- Started on 2024-05-04 01:34:08
...
14	test2	test2	1999-08-03	test2	00000000	2024-05-03	actif
\.
...
5	1	kim	admin	2024-05-04 01:17:22.718069
321	3	andi	vendeur	2024-05-04 01:28:37.286156
6	2	loic	caissier	2024-05-04 01:29:32.497325
...
11	test	test test	7	14	2	En cours	11	180.00	140.00
9	Kardegic	Antiagrégant plaquettaire	4	1	9	actif	22	80.00	60.00
7	Ventoline	Bronchodilatateur	2	6	7	actif	23	100.00	70.00
8	Vogalene	Antiémétique	3	7	8	actif	23	150.00	100.00
10	Efferalgan	Antidouleur et antipyrétique	5	1	10	En cours	30	120.00	90.00
...
SELECT pg_catalog.setval('public.approvisionnement_id_approvisionnement_seq', 17, true);
...
SELECT pg_catalog.setval('public.ligne_vente_id_ligne_vente_seq', 37, true);
...
SELECT pg_catalog.setval('public.login_historique_id_login_seq', 322, true);
...
SELECT pg_catalog.setval('public.vente_id_vente_seq', 19, true);
...
SELECT pg_catalog.setval('public.ventes_payees_id_vente_payee_seq', 16, true);
...
-- Completed on 2024-05-04 01:34:08
